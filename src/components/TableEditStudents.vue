...
import UserAvatar from "@/template/components/UserAvatar.vue";
...
@Options({
  components: {
    CardBoxModal, TableCheckboxCell, BaseButtons, BaseButton, BaseLevel
  },
  props: {
  }
})
...
export default class CreateCourseView extends Vue {
  async mounted()
      : Promise<void> {
    console.log("StudentTable mounted")
  }
}
