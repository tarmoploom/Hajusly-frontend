...
import CardBoxComponentBody from "@/template/components/CardBoxComponentBody.vue";
import CardBoxComponentFooter from "@/template/components/CardBoxComponentFooter.vue";
